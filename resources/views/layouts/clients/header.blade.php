    ...
    <div class="custom-nav">
        ...
        <nav class="nav__pc" aria-label="nav__pc">
            <div class="d-flex align-items-center h-100">
                <a href="#"><img src="https://picsum.photos/40" style="margin-right: 60px; vertical-align: baseline"></a>
        ...
        <div class="nav-mobile__action">
            <a href="#" class="d-flex align-items-center"><img src="https://picsum.photos/40"></a>
