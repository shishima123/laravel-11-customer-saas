...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($user->isUser()) {
            if (session()->has('is_changed_password') && session()->get('is_changed_password')) {
                ...
                return redirect()->route(self::CUSTOMER_SHOW_ROUTE, 'profile')->with([
            ...
            return redirect()->route(self::CUSTOMER_SHOW_ROUTE, 'profile');
        }
        if ($request->ajax()) {
    ...
    public function update(CustomerRequest $request, Customer $customer)
    {
        try {
            ...
            return redirect()->route(self::CUSTOMER_SHOW_ROUTE, 'profile')->with('error', __(self::NOTIFY_ERROR_UPDATE));
        }
    }
